...
1. Motivation
=========================
	BeOS lacked both, an Universal-Scroll option (as known from Logitechs MouseWare program for windows) ans support for 
...
Press and hold down the tertiary mouse button (For typical mice, the middle mouse button is the tertairy mouse button).
Now move your mouse.
